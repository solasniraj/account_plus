...
function viewTheItemsInArray()
{
  ...
  '<td>' + creditAmount + '</td>' +
  '<td>' + chequeNo + '</td>' +
  '<td colspan="2" style="width:200px" ><button type="text" onClick="editItmInTheArray(' + i +')' + '"' + 'class="btn btn-success btn-sm">Edit</button> / <button type="text" onClick="delteItemFromArray(' + i +')' + '"' + 'class="btn btn-danger btn-sm">Delete</button></td></tr>';
...
$("#toggleButton").html('<button   onClick="updateTheItemInTheArray(' + index +')' + '"' + 'class="btn btn-success "   style=" padding:5px;margin:5px;width:70px;font-size:18px;">Update</button></td>');
