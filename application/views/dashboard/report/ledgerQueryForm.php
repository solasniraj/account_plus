                    ...
                    <body>
                        ...
                        <div class="row">
                            <div class="col-md-8 col-md-offset-2">
                                <?php echo form_open_multipart('reports/ledgerReport'); ?>
                                    <?php if(!empty($ledgerDetails)){ ?>
                                    <div class="form-group">
                                        <label class="control-label col-sm-3" for="email"><b>Ledger</b></label>
                                        <div class="col-sm-9">
                                            <select class="form-control" id="sel1" name="ledgerCode">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" id="nepaliDateF" class="form-control1 input-search form-control nepali-calendar" name="nepaliDateF" value="" placeholder="YYYY-MM-DD"/>
        <input type="hidden" id="englishDate" name="englishDateF"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" id="nepaliDateT" class="form-control1 input-search form-control nepali-calendar" name="nepaliDateT" value="" placeholder="YYYY-MM-DD"/>
        <input type="hidden" id="englishDate" name="englishDateT"/>
