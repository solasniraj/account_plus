...
<div id="page-wrapper">
    <div class="graphs">
        <br>
        <h3 class="blank1">Income Expenditure Report Query</h3>
        <div class="xs tabls">
           <div class="invalid">
							 <?php
                    ...
                    <body>
                        ...
                        <div class="row">
                            <div class="col-md-8 col-md-offset-2">
                                <?php echo form_open_multipart('reports/incomeExpnReport', array('id' => '','class'=>'form-horizontal', 'novalidate'=>'novalidate'));?>
        ...
        <input type="hidden" id="englishDateT" name="englishDateT"/>
                                    ...
                                    <div class="lastButton">
                                        <button class="btn btn-success btn-lg" style=" margin-left: 3px; margin-top: -4px;">Show Income Expenditure Report</button>
                                    </div>
<?php echo form_close(); ?>
                            </div>
